    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, "Album A" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "Name", "SubscriptionId" },
                values: new object[] { 1, "john.doe@example.com", "John Doe", 1 });

            migrationBuilder.InsertData(
                table: "Playlists",
                columns: new[] { "Id", "Name", "UserId" },
                values: new object[] { 1, "My Playlist", 1 });

            migrationBuilder.InsertData(
                table: "Songs",
                columns: new[] { "Id", "AlbumId", "ArtistId", "Duration", "Title" },
                values: new object[] { 1, 1, 1, new TimeSpan(0, 0, 3, 45, 0), "Song A" });
